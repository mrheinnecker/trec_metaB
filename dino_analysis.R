...
dino_plot <- asv_overview_per_sample(asv_frac_per_sample, dino_high_abundance, y_annotation="level_8")
...
full_plot <- asv_overview_per_sample(asv_frac_per_sample, euk_high_abundance, y_annotation="level_4")
